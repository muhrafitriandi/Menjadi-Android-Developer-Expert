package com.dicoding.tourismappcoroutineflow.core.data.source.local

import com.dicoding.tourismappcoroutineflow.core.data.source.local.entity.TourismEntity
import com.dicoding.tourismappcoroutineflow.core.data.source.local.room.TourismDao
