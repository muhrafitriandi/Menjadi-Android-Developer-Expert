package com.dicoding.tourismappkoin.core.data.source.local

import com.dicoding.tourismappkoin.core.data.source.local.entity.TourismEntity
import com.dicoding.tourismappkoin.core.data.source.local.room.TourismDao
