package com.dicoding.tourismappdaggerhilt.core.data.source.local

import com.dicoding.tourismappdaggerhilt.core.data.source.local.entity.TourismEntity
import com.dicoding.tourismappdaggerhilt.core.data.source.local.room.TourismDao
