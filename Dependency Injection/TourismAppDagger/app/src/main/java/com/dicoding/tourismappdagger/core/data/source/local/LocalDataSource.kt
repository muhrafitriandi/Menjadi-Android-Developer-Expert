package com.dicoding.tourismappdagger.core.data.source.local

import com.dicoding.tourismappdagger.core.data.source.local.entity.TourismEntity
import com.dicoding.tourismappdagger.core.data.source.local.room.TourismDao
